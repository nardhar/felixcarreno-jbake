...
<head>
    ...
    <meta name="description" content="Felix Carreño's Resumé with brief descriptions of my jobs and personal information">
    <meta name="author" content="Felix Carreño">
    <meta name="keywords" content="felix carreño, felix, carreño, cv, felix carreño cv, carreno, felix carreno cv">
    ...
    <link href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>css/font-awesome.css" rel="stylesheet">
